...
# Parsing + Configuration Script – sadadss - Rev. A

This **Parsing + Configuration** script is designed for the **sadadss** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – sadadss Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **sadadss** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
